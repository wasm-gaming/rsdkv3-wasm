# @wasm-gaming/engine-rsdkv3 — build & preview
#
...
build-lib: node_modules ## Compile SDK/options/manifest → dist/rsdkv3/
...
build-wasm: ## WASM via emscripten/emsdk (Docker) → dist/rsdkv3/rsdkv3.{js,wasm}
